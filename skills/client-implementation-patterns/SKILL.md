...
| 種類 | パス |
|------|------|
| Client Interface | `Packages/StayMonitorCore/Sources/XXXClient/XXXClient.swift` |
| UseCase Interface | `Packages/StayMonitorCore/Sources/XXXUseCase/XXXUseCase.swift` |
| ClientLive | `Packages/StayMonitoriOS/Sources/XXXClientLive/XXXClientLive.swift` |
| UseCaseLive | `Packages/StayMonitoriOS/Sources/XXXUseCaseLive/XXXUseCaseLive.swift` |
